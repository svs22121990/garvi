...
<script runat="server">
    ...
    {
        string mes = string.Empty;
        string sTo = "garvigurjari@s166-62-80-103.secureserver.net";
    ...
    <div class="page-container test">
        ...
        <div class="page-footer-wrapper">
            <div class="page-footer">
                ...
                <a href="http://www.odin.com" target="_blank" class="copyright">&copy; 2015 Parallels IP Holdings GmbH. All rights reserved. Odin and the Odin logo are trademarks of Parallels IP Holdings GmbH.</a>
            </div>
        </div>
        <!-- end: PAGE FOOTER-->
    </div>
