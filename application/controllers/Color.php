...
class Color extends CI_Controller {
    ...
    public function index()
    {
        ...
        if(!empty($_SESSION[SESSION_NAME]['getMenus']))
        {
            ...
            $data = array('breadcrumbs' => $breadcrumbs ,'actioncolumn' => '2' ,'ajax_manage_page' => site_url('Color/ajax_manage_page') , 'heading' => 'Manage Color','addPermission'=>$add,'import' =>$import_buton,'importPermission' =>$import);
    ...
    public function ajax_manage_page()
    {
        ...
        $edit = '';
        $view = '';
        $Data = $this->Color_model->get_datatables();
...
//            }
        ...
        $output = array(
            //"draw" => $_POST['draw'],
            "recordsTotal" => $this->Color_model->count_all(),
            "recordsFiltered" => $this->Color_model->count_filtered(),
            "data" => $data,
        );
    ...
    public function changeStatus(){
        $getasset_types = $this->Crud_model->GetData('color','',"id='".$_POST['id']."'",'','','','row');
        if($getasset_types->status=='Active')
        {
            $this->Crud_model->SaveData('color',array('status'=>'Inactive'),"id='".$_POST['id']."'");
        }
        else
        {
            $this->Crud_model->SaveData('color',array('status'=>'Active'),"id='".$_POST['id']."'");
        }
    ...
    public function addData()
    {
        ...
        $duplication = $this->Crud_model->GetData('color','', $condDuplication);
        ...
        else
        {
            ...
            $this->Crud_model->SaveData('color', $data);
    ...
    {
        $row = $this->Crud_model->GetData('color','',"id='".$_POST['id']."'",'','','','row');
    ...
    public function updateData()
    {
        ...
        else
        {
            ...
            $this->Crud_model->SaveData('color', $data, "id='".$this->input->post('id')."'");
            $this->session->set_flashdata('message', 'success');
    ...
    {
        $con = "id='".$_POST['id']."'";
        $this->Crud_model->DeleteData('color',$con);
