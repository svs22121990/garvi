...
class Fabric extends CI_Controller {
    ...
    public function index()
    {
        ...
        if(!empty($_SESSION[SESSION_NAME]['getMenus']))
        {
            ...
            $breadcrumbs = "<ul class='breadcrumb'>
                    ...
                    <li class='active'>Manage Fabric</li>
                    </ul>";
            $data = array('breadcrumbs' => $breadcrumbs ,'actioncolumn' => '2' ,'ajax_manage_page' => site_url('Fabric/ajax_manage_page') , 'heading' => 'Manage Fabric','addPermission'=>$add,'import' =>$import_buton,'importPermission' =>$import);
    ...
    public function ajax_manage_page()
    {
        ...
        $edit = '';
        $view = '';
        $Data = $this->Fabric_model->get_datatables();
...
//            }
        ...
        $output = array(
            //"draw" => $_POST['draw'],
            "recordsTotal" => $this->Fabric_model->count_all(),
            "recordsFiltered" => $this->Fabric_model->count_filtered(),
            "data" => $data,
        );
    ...
    public function changeStatus(){
        $getasset_types = $this->Crud_model->GetData('fabric','',"id='".$_POST['id']."'",'','','','row');
        if($getasset_types->status=='Active')
        {
            $this->Crud_model->SaveData('fabric',array('status'=>'Inactive'),"id='".$_POST['id']."'");
        }
        else
        {
            $this->Crud_model->SaveData('fabric',array('status'=>'Active'),"id='".$_POST['id']."'");
        }
        $this->session->set_flashdata('message', '<span class="label label-success text-center" style="margin-bottom:0px;">Status has been changed successfully</span>');
        redirect(site_url('Fabric'));
    }
    ...
    public function addData()
    {
        ...
        $duplication = $this->Crud_model->GetData('fabric','', $condDuplication);
        ...
        else
        {
            ...
            $this->Crud_model->SaveData('fabric', $data);
    ...
    {
        $row = $this->Crud_model->GetData('fabric','',"id='".$_POST['id']."'",'','','','row');
    ...
    public function updateData()
    {
        ...
        else
        {
            ...
            $this->Crud_model->SaveData('fabric', $data, "id='".$this->input->post('id')."'");
            $this->session->set_flashdata('message', 'success');
    ...
    {
        $con = "id='".$_POST['id']."'";
        $this->Crud_model->DeleteData('fabric',$con);
