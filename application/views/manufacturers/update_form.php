                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Please Select Contry<span style="color: red">*</span></label>
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="country_id" id="country_id" onchange="get_state_by_country(this.value);">
                                                        <option value="">--Select Country Name--</option>
                                                        <?php foreach($country_data as $country_dataRow) { ?>                                                         
                                                        <option value="<?php echo $country_dataRow->id?>"<?php if($getBranchData->state_id==$country_dataRow->id)echo "selected";?>><?php echo $country_dataRow->country_name?>
                                              ...
                                              <div class="form-group">
                                                <label class="col-md-3 control-label">Please Select State<span style="color: red">*</span></label>
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control state" name="state_id" id="state_id" onchange="get_city_by_state(this.value);">
                                                        <option value="">--Select State Name--</option>
                                                         <?php
                                                                   foreach ($state_data as $row_data) 
                                                                   {  
                                                                    ?>
                                                                    <option  value="<?php echo $row_data->id; ?>"<?php if($getBranchData->state_id==$row_data->id)echo "selected";?>><?php echo $row_data->state_name; ?></option>
                                                                    <?php } ?>
                                              ...
                                              <div class="form-group">
                                                <label class="col-md-3 control-label">Please Select City<span style="color: red">*</span></label>
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control city" name="city_id" id="city_id">
                                                        <option value="">--Select City Name--</option>

                                                         <?php
                                                                   foreach ($city_data as $row_data) 
                                                                   {  
                                                                    ?>
                                                                    <option  value="<?php echo $row_data->id; ?>"<?php if($getBranchData->city_id==$row_data->id)echo "selected";?>><?php echo $row_data->city_name; ?></option>
                                                                    <?php } ?>
