    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                ?>
              <form method="post" action="<?=site_url("Daily_Sales/export_daily_sales/$formatted_date/$selected_date/$selected_type/$selected_type2/$selected_type3")?>">
                    ...
                    <ul class="panel-controls">
                       ...
                       // print_r($import);
                        ...
                        <?php if($exportPermission=='1'){?>
						              <li>
                            <a href="<?= base_url(); ?>index.php/Daily_Sales/listpdf/<?= $selected_date ?>/<?= $selected_type ?>/<?= $selected_type2 ?>/<?= $selected_type3 ?>" target="_blank"><span title="PDF" class="fa fa-file-pdf-o"></span></a>
                          </li>
                          <li><?=$export; ?></li>
