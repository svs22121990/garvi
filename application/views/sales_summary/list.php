    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                ?>
              <form method="post" action="<?=site_url("Sales_Summary/export_sales_summary/$formatted_date/$selected_type/$selected_type2/$selected_type3")?>">
...
<!--						<li>-->
<!--                            <a href="--><?//= base_url(); ?><!--index.php/Sales_Summary/listpdf/--><?//= $formatted_date ?><!--/--><?//= $selected_type ?><!--/--><?//= $selected_type2 ?><!--/--><?//= $selected_type3 ?><!--" target="_blank"><span title="PDF" class="fa fa-file-pdf-o"></span></a>-->
<!--                          </li>-->
                          <li><?=$export; ?></li>
