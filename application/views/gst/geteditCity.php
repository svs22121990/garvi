...
<!--End State Edit-->
  ...
  <input class="form-control" type="text" name="gst_percent" id="gst_percent1" placeholder="GST %" value="<?php echo $gst_percent ?>" size="35"/> &nbsp;
  </div> 

  <div class="form-line">
   <label>Markup %&nbsp;<span style="color:red">*</span>&nbsp;<span id="EdittitleError4" style="color:red"></span> </label>
  <input class="form-control" type="text" name="markup_percent" id="markup_percent1" placeholder="Markup %" value="<?php echo $markup_percent ?>" size="35"/> &nbsp;
  </div> 
