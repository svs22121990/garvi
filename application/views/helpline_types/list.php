...
<div class="modal inmodal" id="checkStatus" data-modal-color="lightblue" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content animated bounceInRight">   
            <form method="post" action="<?= site_url('Helpline_types/changeStatus') ?>">       
...
<?php $this->load->view('common/footer');?>
 ...
 <script type="text/javascript">
    function saveData()
    {
        ...
        $.ajax({
          type : "post",
          url : "<?php echo site_url('Helpline_types/addData') ?>",
          data : datastring,
...
function getEditvalue(rowid)
    {     
        ...
        $.ajax({
          type: "POST",
          url: "<?= site_url('Helpline_types/getUpdateName'); ?>",
          data: {id:rowid},
          cache: false,       
    ...
    function updateData()
    {
       ...
       if($.trim(type) == "")
        ...
        $.ajax({
          type : "post",
          url : "<?php echo site_url('Helpline_types/updateData') ?>",
          data : datastring,
          success : function(response)
          {
            if(response == 1)
