	...
	<body>
		  <div id="container">
		  		<div id="content-wrapper">
		  		    <div>
		  		    	<div style="padding: 2px;"><h3>Catgory Name : <?php echo str_replace('%20', ' ', $category_name); ?> (Qty = <?= count($barcodes) ?>) </h3></div>
		  		    	<table cellpadding="0px" cellspacing="0px" width="1000px" align="center" border="1px" id="second-table">
		  		    		
		  		    		<tr>
		  		    		<?php $sr=0; foreach($barcodes as $row) { if ($sr % 5 == 0) { echo '</tr>'; } ?>
