          ...
          <div class="panel-heading">
            <h3 class="panel-title"><strong><?= $heading ?>
              ...
              <ul class="panel-controls">
               <li><a href="<?= site_url('Dispatch/index')?>" ><span class="fa fa-arrow-left"></span></a></li>
             </ul>
           </div>
            ...
            <div class="row">
              <div class="col-md-12" style="padding: 0;"> 
				...
				<?php if(isset($dispatch)): ?>
					<input type="hidden" value="<?= $dispatch->id; ?>" name="sales_return_id">
				<?php endif; ?>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <div class="col-md-11">
                      <input type="text" name="date" id="date" class="form-control datepicker" placeholder="Date" value="<?php if(isset($dispatch)){ echo $dispatch->return_date; } ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label class="col-md-11"> Return From <span style="color: red">*</span> <span  id="sent_to_error" style="color: red"></span></label>
                    <div class="col-md-11">
                      <input type="text" class="form-control" name="r_from" id="sent_to" value="<?php if(isset($dispatch)){ echo $dispatch->r_from; } ?>">
		  ...
		  <?php if(!isset($view)): ?>
			...
			<tr class="trRow">
              ...
              <td class="text-center">
				<a href="<?= base_url(); ?>index.php/sales_return/edit_action/<?= $d->id ?>/<?= $dispatch->id ?>" class="btn  btn-sm btn-success"><i class="fa fa-edit"></i></a>
                <a href="<?= base_url(); ?>index.php/sales_return/remove/<?= $d->id ?>/<?= $dispatch->id ?>" class="btn  btn-sm btn-danger"><i class="fa fa-minus"></i></a>
...
jQuery(document).on('click','#save_finish',function(){
	...
	$("#myForm").attr("action","<?= base_url(); ?>index.php/sales_return/create_action/finish");
	$( "#myForm" ).submit();
...
function getGST(val,len) {
  ...
  //alert(dataString);
	var url = site_url+"/Dispatch/getGST";
...
function validateinfo() { 
  ...
  if(dn_no=='') {
    ...
    $("#sent_to_error").html("Please Enter customer name").fadeIn();
