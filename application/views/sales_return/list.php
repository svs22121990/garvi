...
<div class="page-content-wrap"> 
    <div class="row">
        <div class="col-md-12">
			...
			<?= form_open('sales_return/search',['id'=>'serch_date']); ?>
                  ...
                  <?= form_close(); ?>
			  <?php if($dateinfo!=0){ ?>
              <form method="post" action="<?=site_url("sales_return/export_dispatch1/$dateinfo")?>">
			  <?php }else{ ?>
			  <form method="post" action="<?=site_url('sales_return/export_dispatch1')?>">
			  <?php } ?>
                <div class="panel-heading">                                
                    ...
                    <ul class="panel-controls">
                        ...
                        <?php } ?>
						  ...
						  <li>
						    <?php if($dateinfo!=0){ ?>
							<a href="<?= base_url(); ?>index.php/sales_return/listpdf/<?= $dateinfo; ?>" target="_blank"><span title="PDF" class="fa fa-file-pdf-o"></span></a>
							<?php } else { ?>
                            <a href="<?= base_url(); ?>index.php/sales_return/listpdf" target="_blank"><span title="PDF" class="fa fa-file-pdf-o"></span></a>
							<?php } ?>
                          </li>
                          <li><?=$export; ?></li>
                         ...
                         <li><a href="<?php echo site_url("sales_return/create")?>" ><span class="fa fa-plus"></span></a></li>
