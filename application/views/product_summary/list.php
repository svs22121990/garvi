    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?= form_open('Product_Summary/search',['id'=>'serch_date']); ?>
                ...
                ?>
                <form method="post" action="<?=site_url("Product_Summary/export_product_summary/$formatted_date/$selected_type/$selected_type2/$selected_color/$selected_size/$selected_fabric/$selected_craft/$selected_cat")?>">
