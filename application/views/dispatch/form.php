		  ...
		  <?php if(!isset($view)): ?>
			...
			<tr class="trRow">
              ...
              <td class="text-center">
				<a href="<?= base_url(); ?>index.php/dispatch/edit_action/<?= $d->id ?>/<?= $dispatch->id ?>" class="btn  btn-sm btn-success"><i class="fa fa-edit"></i></a>
                <a href="<?= base_url(); ?>index.php/dispatch/remove/<?= $d->id ?>/<?= $dispatch->id ?>" class="btn  btn-sm btn-danger"><i class="fa fa-minus"></i></a>
...
jQuery(document).on('click','#save_finish',function(){
	...
	$("#myForm").attr("action","<?= base_url(); ?>index.php/dispatch/create_action/finish");
	$( "#myForm" ).submit();
