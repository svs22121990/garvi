                                            ...
                                            <div class="table-responsive">
                                              <table class="table table-bordered" id="purchaseTableclone123" >
                                                ...
                                                <tbody id="clonetable_feedback">
                                                  ...
                                                  <tr class="rows">
                                                    <td>
                                                      <input type="text" value="" name="asset_name[]" id="attributename1" class="col-sm-12 attrname blkclr form-control asset_name" placeholder="Asset Name"/>
                                                      <div class="app searchbox1" id="searchbox1"></div> 
                                                    </td>
                                                    <td>
                                                       <input type="text" value="" name="quantity[]" id="value1" class="col-sm-12 blkclr form-control" placeholder="Quantity" maxlength="6" onkeypress="only_number(event)"/>
...
<script type="text/javascript">
   ...
   {   
       ...
       var inp21 = new_row.cells[0].getElementsByTagName('div')[0];
       inp21.value = '';
       inp21.id = 'searchbox'+(len+1);
