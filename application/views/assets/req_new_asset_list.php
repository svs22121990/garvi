            ...
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title"><strong><?= $heading ?></strong></h3>
                     <h3><span class="msghide"><?= $this->session->userdata('message') <> '' ? $this->session->userdata('message') : ''; ?></span></h3>
                    <ul class="panel-controls">
                      <?php if($addPermission=='1'){?>
                        <li><a href="<?php echo site_url("Assets/req_new_asset")?>" title="New Asset Request"><span class="fa fa-plus"></span></a></li>
                       <?php }?>
...
<script type="text/javascript">
  var url="<?= site_url('Assets/req_new_asset_listAjax/'); ?>";
  var actioncolumn="4";
</script>
<script type="text/javascript">
...
<div class="modal fade" id="deleteData" data-modal-color="lightblue" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">   
            <form method="post" action="<?= site_url('Assets/assets_req_delete') ?>">       
