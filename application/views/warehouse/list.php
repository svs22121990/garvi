        ...
        <div class="col-md-12">
            ...
            <?= form_open('Warehouse/search',['id'=>'serch_date']); ?>
                ...
                <div class="panel-heading">
                    <h3 class="panel-title"><strong><?= $heading ?> Products</strong></h3>
                    ...
                    <ul class="panel-controls">
                        ...
                        <li><a href="<?php echo site_url("Warehouse/pdf_summary/$formatted_date")?>" target="_blank"><span title="PDF" class="fa fa-file-pdf-o"></span></a></li>
                        <li><a href="<?php echo site_url("Warehouse/export_bill_summary/$formatted_date")?>"><span title="Export" class="fa fa-file-excel-o"></span></a></li>
                ...
                <div class="panel-body ">
                    <div class="table-responsive">
                        <?php if($addPermission=='1'){?>
							...
							<a href="<?php echo site_url("Warehouse/create")?>" class="btn btn-success" style="color:white;">
...
<div class="modal fade" id="deleteData" data-modal-color="lightblue" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form method="post" action="<?= site_url('Warehouse/delete') ?>">
...
<script type="text/javascript">
    function getassetvalue(rowid)
    {
        $.ajax({
            type: "POST",
            url: "<?= site_url('Warehouse/getassetdetail'); ?>",
            data: {id:rowid},
            cache: false,
