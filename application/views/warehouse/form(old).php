                            ...
                            <div style="width: 1600px; margin: 0 auto;">
                                <table class="table table-striped table-bordered" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <th> Markup 1 %<span style="color: red">*</span><span style="color: red" id="Markup1"></span></th>
                                        <th> Markup 2 %<span style="color: red">*</span><span style="color: red" id="Markup2"></span></th>
                                    ...
                                    <tr class="trRow">
                                        ...
                                        <td>
                                            <input type="text" class="form-control markup" name="markup[]" id="markup1" readonly="readonly" placeholder=" Markup 1" autocomplete="off">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control markup_2" name="markup_2[]" id="markup2" readonly="readonly" placeholder=" Markup 2" autocomplete="off">
                                        </td>
                                        <td>
                                    ...
                                    <tfoot>
                                    <tr>
                                        <th colspan="14"><span class="pull-right">Total Markup Amt 1</span></th>
                                        <th>
                                            <!-- <input type="text" class="form-control" id="totalSGST" readonly="readonly" value="0"> -->
                                            <input type="text" class="form-control" name="gtotal" id="grandTotal" readonly="readonly" value="0">
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="15"><span class="pull-right">Total Markup Amt 2</span></th>
                                        <th>
                                            <input type="text" class="form-control" id="totalSGST" readonly="readonly" value="0">
                                        </th>
                                    </tr>
                                    ...
                                    <tr>
                                        <th colspan="15" >&nbsp;<span class="pull-right">Total SP Amt.1 </span></th>
                                        <th colspan="3">
                                            <input type="text" class="form-control" id="spTotal" readonly="readonly" value="0">
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="15" >&nbsp;<span class="pull-right">Total SP Amt.2 </span></th>
                                        <th colspan="3">
                                            <input type="text" class="form-control" id="spTotal" readonly="readonly" value="0">
                                        </th>
                                    </tr>
...
<script type="text/javascript">
    ...
    function addrow() {
        ...
        var inp9 = new_row.cells[14].getElementsByTagName('input')[0];
        inp9.value = '';
        inp9.id = 'markup_2'+(len+1);
