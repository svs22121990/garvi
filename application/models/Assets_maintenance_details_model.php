...
class Assets_maintenance_details_model extends CI_Model
{
    ...
    var $column_order = array(null,'mst_asset_types.type','assets.asset_name','asset_details.barcode_number','asset_details.image','assets_maintenance.date','assets_maintenance.received_date','assets_maintenance.price','assets_maintenance.description',null); //set column field database for datatable orderable
    var $column_search = array('mst_asset_types.type','assets.asset_name','asset_details.barcode_number','asset_details.image','assets_maintenance.date','assets_maintenance.received_date','assets_maintenance.price','assets_maintenance.description'); //set column field database for datatable searchable
    var $order = array('assets_maintenance.id' => 'desc'); // default order
 
    private function _get_datatables_query($con)
    {
         
        $this->db->select('assets_maintenance.*,assets.asset_name,asset_details.barcode_number,asset_details.image,mst_asset_types.type');
