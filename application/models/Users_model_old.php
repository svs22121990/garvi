...
class Users_model extends CI_Model
{
    ...
    /*-------------------------GETTTING CITIES DATA SERVER SIDE MODEL CODE----------------*/
     var $column_order = array(null,'name',null,null,null,null,null); //set column field database for datatable orderable
     var $column_search = array('name','gst_number'); //set column field database for datatable searchable
