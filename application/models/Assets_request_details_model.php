...
class Assets_request_details_model extends CI_Model
{
    public $table = 'asset_details';
    var $column_order = array(null,'ard.asset_name','ard.quantity','ard.description',null); //set column field database for datatable orderable
    var $column_search = array('ard.asset_name','ard.quantity','ard.description'); //set column field database for datatable searchable 
