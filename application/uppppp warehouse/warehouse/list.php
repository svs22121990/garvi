    ...
    <div class="row">
        <div class="col-md-12">
			...
			<?= form_open('Warehouse/search',['id'=>'serch_date']); ?>
                  ...
                  <?= form_close(); ?>
			  <?php if($dateinfo!=0){ ?>
              <form method="post" action="<?=site_url("Warehouse/export_dispatch1/$dateinfo")?>">
			  <?php }else{ ?>
			  <form method="post" action="<?=site_url('Warehouse/export_dispatch1')?>">
			  <?php } ?>
                <div class="panel-heading">                                
                    ...
                    <ul class="panel-controls">
                        ...
                        <?php if($exportPermission=='1'){?>
						  <li>
						    <?php if($dateinfo!=0){ ?>
							<a href="<?= base_url(); ?>index.php/Warehouse/listpdf/<?= $dateinfo; ?>" target="_blank"><span title="PDF" class="fa fa-file-pdf-o"></span></a>
							<?php } else { ?>
                            <a href="<?= base_url(); ?>index.php/Warehouse/listpdf" target="_blank"><span title="PDF" class="fa fa-file-pdf-o"></span></a>
							<?php } ?>
                          </li>
                          <li><?=$export; ?></li>
                        ...
                        <?php if($addPermission=='1'){?>
                         <li><a href="<?php echo site_url("Warehouse/create")?>" ><span class="fa fa-plus"></span></a></li>
